...
def main():
    ...
    videoGameWindowTitle = "apex"

    # Portion of screen to be captured (This forms a square/rectangle around the center of screen)
    screenShotHeight = 250
    screenShotWidth = 250

    # How big the Autoaim boxshould be around the center of the screen
    aaDetectionBox = 250
    ...
    # sctArea = {"mon": 1, "top": 0, "left": 0, "width":  2560, "height": 1440}
    ...
    while win32api.GetAsyncKeyState(ord(aaQuitKey)) == 0:
        ...
        if len(targets) > 0:
            ...
            eDistance = math.dist([mouseMove[0],100],[mouseMove[1],100])
            #print(eDistance)
